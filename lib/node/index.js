...
var _class = function (_PubNubCore) {
  ...
  function _class(setup) {
    ...
    setup.networking = new _networking2.default({ keepAlive: _node.keepAlive, del: _webNode.del, get: _webNode.get, post: _webNode.post, put: _webNode.put, proxy: _node.proxy });
